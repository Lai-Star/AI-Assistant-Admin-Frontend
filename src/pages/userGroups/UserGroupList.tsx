...
const UserGroupList: React.FC = () => {
    ...
    return (
        <Layout>
            <Toaster />
            <TitleComponent>User Groups</TitleComponent>
            <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link to={'/userGroups/add/'}>
                        <Button className="bg-primary-400 text-white">Register User Group</Button>
                    </Link>
                </div>
                            ...
                            <>
                                {companies.length > 0 ? (
                                    <table className="min-w-full table-auto">
                                        ...
                                        <tbody>
                                            <tr className="border-b">
                                                ...
                                                <td className="px-4 py-2 text-left">56</td>
                                    ...
                                    <div className="flex flex-col justify-center items-center h-96 bg-white">
                                        <h1 className="font-bold">No Registered User Groups</h1>
