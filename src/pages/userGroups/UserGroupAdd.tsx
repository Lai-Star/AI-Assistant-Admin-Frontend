...
const userGroupsAdd = () => {
    ...
    const onSubmit = async (data: any) => {
        ...
        console.log('Data sent:', { name, email, registration, password })
        const formData = {
            name,
            email,
            registration,
        ...
        try {
            const response = await axios.post('http://192.168.17.11:8000/api/companies/save',
                formData,
                {
                    headers
                }
    ...
    const breadcrumbItems = [{ label: 'User Groups' }, { label: 'User Group Registration' }]
