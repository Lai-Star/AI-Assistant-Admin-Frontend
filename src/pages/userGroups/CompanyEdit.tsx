...
import serverConfig from '../../../config/index.tsx'
...
const CompanyEdit = () => {
    ...
    useEffect(() => {
        async function fetchCompany() {
            try {
                ...
                const response = await axios.get(`http://${serverConfig.serverUrl}/api/companies/${id}`, {
                    headers
                    // params: {
                    //     id: id
                    // }
    ...
    const onSubmit = async (data: companyFormInputs) => {
        ...
        try {
            await axios.post(`http://${serverConfig.serverUrl}/api/companies/save`, formData, {
                headers
            })
            toast({
