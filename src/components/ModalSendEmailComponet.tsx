...
interface ModalSendEmailComponentProps {
    isOpen: boolean;
}

const ModalSendEmailComponent: React.FC<ModalSendEmailComponentProps> = ({ isOpen }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-lg shadow-lg max-w-sm mx-auto p-6 relative z-10">
                <div className="flex flex-col justify-center space-y-4">
                    ...
                    <img src={logoOk} height={50} width={50} className="mx-auto" alt="Email sent confirmation" />
